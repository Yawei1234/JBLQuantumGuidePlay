  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      1: [
        ...
        {
          "./lib/ControlKit": 2,
          "./lib/component/Canvas": 5,
          "./lib/component/SVG": 22,
        },
      ],
      2: [
        function (require, module, exports) {
          ...
          function ControlKit(options) {
            ...
            options = options || {};
            options.history =
              options.history === undefined ? DEFAULT_HISTORY : options.history;
            options.loadAndSave =
              options.loadAndSave === undefined
                ? DEFAULT_LOAD_AND_SAVE
                : options.loadAndSave;
            options.opacity =
              options.opacity === undefined ? DEFAULT_OPACITY : options.opacity;
            options.panelsClosable =
              options.panelsClosable === undefined
                ? DEFAULT_PANELS_CLOSABLE
                : options.panelsClosable;
            options.useExternalStyle =
              options.useExternalStyle === undefined
                ? false
                : options.useExternalStyle;
            options.enable =
              options.enable === undefined ? DEFAULT_ENABLE : options.enable;
            ...
            if (!options.useExternalStyle) {
              ...
              var css = !options.style
                ? require("./core/document/Style").string
                : options.styleString;
              if (style.stylesheet) {
            ...
            document.addEventListener("keydown", function (e) {
              if (
                !(
                  e.ctrlKey &&
                  String.fromCharCode(e.which || e.keyCode).toLowerCase() ==
                    self._shortcutEnable
                )
              ) {
                return;
              }
            ...
            while (++i < l) {
              ...
              while (++j < m) {
                ...
                while (++k < n) {
                  ...
                  if (
                    component instanceof ValuePlotter ||
          ...
          ControlKit.prototype.onHistoryStatePop = function () {
            this.dispatchEvent(
              new Event_(this, ComponentEvent.UPDATE_VALUE, { origin: null })
            );
            this.dispatchEvent(new Event_(this, MenuEvent.UPDATE_MENU, null));
          };
        ...
        {
          "./component/NumberOutput": 15,
          "./component/Options": 16,
          "./component/Picker": 19,
          "./component/StringOutput": 28,
          "./component/ValuePlotter": 29,
          "./core/ComponentEvent": 31,
          "./core/History": 33,
          "./core/HistoryEvent": 34,
          "./core/State": 38,
          "./core/document/CSS": 42,
          "./core/document/DocumentEvent": 43,
          "./core/document/Mouse": 44,
          "./core/document/Node": 45,
          "./core/document/NodeEvent": 46,
          "./core/document/Style": 47,
          "./core/event/Event": 48,
          "./core/event/EventDispatcher": 49,
          "./group/MenuEvent": 55,
          "./group/Panel": 56,
        },
      ],
      3: [
        function (require, module, exports) {
          ...
          function Button(parent, label, onPress, params) {
            ...
            var self = this;
            node.addEventListener(NodeEvent.ON_CLICK, function () {
              onPress.bind(self)();
              self.dispatchEvent(
                new Event_(self, ComponentEvent.VALUE_UPDATED)
              );
            });
      ...
      4: [
        function (require, module, exports) {
          ...
          function ButtonPreset(parentNode) {
            ...
            node.addEventListener(
              NodeEvent.MOUSE_DOWN,
              this._onMouseDown.bind(this)
            );
            node.addChild(imgNode);
            parentNode.addChildAt(node, 0);
            ObjectComponentNotifier.get().addEventListener(
              OptionEvent.TRIGGER,
              this,
              "onOptionTrigger"
            );
            this.addEventListener(
              OptionEvent.TRIGGERED,
              ObjectComponentNotifier.get(),
              "onOptionTriggered"
            );
          }
        ...
        {
          "../core/ObjectComponentNotifier": 36,
          "../core/OptionEvent": 37,
          "../core/document/CSS": 42,
          "../core/document/Node": 45,
          "../core/document/NodeEvent": 46,
        ...
        function (require, module, exports) {
          ...
          function Canvas(parent, params) {
            ...
            this._parent.addEventListener(
              GroupEvent.GROUP_SIZE_CHANGE,
              this,
              "onGroupSizeChange"
            );
            this.addEventListener(
              GroupEvent.GROUP_SIZE_UPDATE,
              this._parent,
              "onGroupSizeUpdate"
            );
          }
          ...
          Canvas.prototype.onGroupSizeChange = function () {
            ...
            this._redraw();
            this.dispatchEvent(
              new Event_(this, GroupEvent.GROUP_SIZE_UPDATE, null)
            );
          };
      ...
      6: [
        function (require, module, exports) {
          ...
          Checkbox.prototype.applyValue = function () {
            ...
            obj[key] = !obj[key];
            this.dispatchEvent(
              new Event_(this, ComponentEvent.VALUE_UPDATED, null)
            );
          };
      ...
      7: [
        function (require, module, exports) {
          ...
          var MSG_COLOR_FORMAT_HEX =
              "Color format should be hex. Set colorMode to rgb, rgbfv or hsv.",
            MSG_COLOR_FORMAT_RGB_RGBFV_HSV =
              "Color format should be rgb, rgbfv or hsv. Set colorMode to hex.",
            MSG_COLOR_PRESET_FORMAT_HEX = "Preset color format should be hex.",
            MSG_COLOR_PRESET_FORMAT_RGB_RGBFV_HSV =
              "Preset color format should be rgb, rgbfv or hsv.";
          function Color(parent, object, value, params) {
            ...
            this._validateColorFormat(
              value,
              MSG_COLOR_FORMAT_HEX,
              MSG_COLOR_FORMAT_RGB_RGBFV_HSV
            );
            var wrap = this._wrapNode;
            if (!this._presetsKey) {
            ...
            color.addEventListener(
              NodeEvent.MOUSE_DOWN,
              this._onColorTrigger.bind(this)
            );
            this._updateColor();
          }
          ...
          Color.prototype._validateColorFormat = function (
            value,
            msgHex,
            msgArr
          ) {
        ...
        {
          "../core/ComponentEvent": 31,
          "../core/color/ColorFormatError": 39,
          "../core/color/ColorMode": 40,
          "../core/color/ColorUtil": 41,
          "../core/document/CSS": 42,
          "../core/document/Node": 45,
          "../core/document/NodeEvent": 46,
          "../core/event/Event": 48,
      ...
      9: [
        function (require, module, exports) {
          ...
          var DEFAULT_FUNCTION_PLOTTER_NON_IMPLICIT_UNIT_X = 1,
            ...
            DEFAULT_FUNCTION_PLOTTER_NON_IMPLICIT_SCALE = 10,
            DEFAULT_FUNCTION_PLOTTER_IMPLICIT_SCALE = 1,
            DEFAULT_FUNCTION_PLOTTER_SCALE_MIN = 0.02,
            DEFAULT_FUNCTION_PLOTTER_SCALE_MAX = 25,
            DEFAULT_FUNCTION_PLOTTER_IMPLICIT_AXES_COLOR =
              "rgba(255,255,255,0.75)",
            DEFAULT_FUNCTION_PLOTTER_IMPLICIT_GRID_COLOR =
              "rgba(25,25,25,0.75)",
          ...
          function FunctionPlotter(parent, object, value, params) {
            ...
            params.showMinMaxLabels =
              params.showMinMaxLabels === undefined
            ...
            var svgRoot = this._svgRoot,
              path = this._path;
            var axes = (this._axes = svgRoot.insertBefore(
              this._createSVGObject("path"),
              path
            ));
            axes.style.strokeWidth = 1;
            var axesLabels = (this._axesLabels = svgRoot.insertBefore(
              this._createSVGObject("path"),
              path
            ));
            ...
            if (plotMode == FunctionPlotType.IMPLICIT) {
              ...
              this._canvasImageData = this._canvasContext.getImageData(
                0,
                0,
                size,
                size
              ...
              grid.style.stroke =
                DEFAULT_FUNCTION_PLOTTER_NON_IMPLICIT_GRID_COLOR;
            }
            wrapNode.addChild(sliderXWrap);
            wrapNode.addChild(sliderYWrap);
            sliderXHandle.addEventListener(
              NodeEvent.MOUSE_DOWN,
              this._onSliderXHandleDown.bind(this)
            );
            sliderYHandle.addEventListener(
              NodeEvent.MOUSE_DOWN,
              this._onSliderYHandleDown.bind(this)
            );
            ...
            this._unitsMinMax = [
              DEFAULT_FUNCTION_PLOTTER_UNIT_MIN,
              DEFAULT_FUNCTION_PLOTTER_UNIT_MAX,
            ];
            this._scaleMinMax = [
              DEFAULT_FUNCTION_PLOTTER_SCALE_MIN,
              DEFAULT_FUNCTION_PLOTTER_SCALE_MAX,
            ];
            ...
            svg.addEventListener(
              DocumentEvent.MOUSE_DOWN,
              this._onDragStart.bind(this),
              false
            );
            this._wrapNode
              .getElement()
              .addEventListener("mousewheel", this._onScale.bind(this, false));
            ObjectComponentNotifier.get().addEventListener(
              ComponentEvent.UPDATE_VALUE,
              this,
              "onValueUpdate"
            );
          }
          ...
          FunctionPlotter.prototype._onScale = function (e) {
            e = window.event || e;
            this._scale +=
              Math.max(-1, Math.min(1, e.wheelDelta || -e.detail)) * -1;
            var scaleMinMax = this._scaleMinMax;
            this._scale = Math.max(
              scaleMinMax[0],
              Math.min(this._scale, scaleMinMax[1])
            );
            this._plotGraph();
            e.preventDefault();
          };
          ...
          FunctionPlotter.prototype._drawGrid = function () {
            ...
            var labelTickSize = Metric.FUNCTION_PLOTTER_LABEL_TICK_SIZE,
              ...
              labelTickPaddingRightOffset =
                labelTickPaddingRight - labelTickSize,
              labelTickPaddingBottomOffset =
                labelTickPaddingBottom - labelTickSize,
              labelTickOffsetRight =
                labelTickPaddingRight - (labelTickSize + strokeSize) * 2,
              labelTickOffsetBottom =
                labelTickPaddingBottom - (labelTickSize + strokeSize) * 2;
            i = -1;
            while (++i < gridNumTop) {
          ...
          FunctionPlotter.prototype._onSliderHandleDown = function (
            sliderStepFunc
          ) {
          ...
          FunctionPlotter.prototype._sliderXHandleUpdate = function () {
            ...
            handleX.setPositionX(
              handleXMin +
                (handleXMax - handleXMin) *
                  ((unitX - unitMin) / (unitMax - unitMin)) -
                handleXWidthHalf
            );
          };
          FunctionPlotter.prototype._sliderYHandleUpdate = function () {
            ...
            handleY.setPositionY(
              handleYMin +
                (handleYMax - handleYMin) *
                  ((unitY - unitMin) / (unitMax - unitMin)) -
                handleYHeightHalf
            );
          };
        ...
        },
        {
          ...
          "../core/document/NodeEvent": 46,
          "./FunctionPlotType": 8,
          "./FunctionPlotterFunctionArgsError": 10,
          "./FunctionPlotterObjectError": 11,
          "./Metric": 12,
          "./Plotter": 20,
        },
      ],
      10: [
        function (require, module, exports) {
          ...
          FunctionPlotterFunctionArgsError.prototype = Object.create(
            Error.prototype
          );
          FunctionPlotterFunctionArgsError.prototype.constructor =
      ...
      11: [
        function (require, module, exports) {
          ...
          FunctionPlotterObjectError.prototype.constructor =
      ...
      13: [
        function (require, module, exports) {
          ...
          function NumberInput(parent, object, value, params) {
            ...
            params.dp =
              params.dp === undefined || params.dp == null
                ? DEFAULT_INPUT_DP
                : params.dp;
            ...
            this._onChange = params.onChange;
            this._presetsKey = params.presets;
            var input = (this._input = new NumberInput_Internal(
              params.step,
              params.dp,
              params.onBegin,
              this._onInputChange.bind(this),
            ...
            if (!presets) {
              ...
              var options = Options.get();
              var presetBtn = (this._btnPreset = new ButtonPreset(
                this._wrapNode
              ));
              var onPresetDeactivate = function () {
                options.clear();
            ...
            input
              ...
              .addEventListener(
                NodeEvent.MOUSE_DOWN,
                this._onInputDragStart.bind(this)
              );
            this.addEventListener(
              ComponentEvent.INPUT_SELECT_DRAG,
              this._parent,
              "onComponentSelectDrag"
            );
      ...
      14: [
        function (require, module, exports) {
            ...
            if (!setCaretPos) {
              if (input.getElement().setSelectionRange) {
                ...
                selectAll = function (input) {
                  input
                    .getElement()
                    .setSelectionRange(0, input.getProperty("value").length);
                };
              } else {
                setCaretPos = function (input, pos) {
          ...
          NumberInput_Internal.prototype = Object.create(
          ...
          NumberInput_Internal.prototype._onKeydown = function (e) {
            ...
            if (isAllSelected) {
              if (isMinus) {
                ...
                inputSetValue(
                  input,
                  isBackspaceDelete ? 0 : String.fromCharCode(keyCode)
                );
            ...
            if (isUpDown) {
              var step =
                  (isShift ? PRESET_SHIFT_MULTIPLIER : 1) * this._valueStep,
                mult = keyCode == 38 ? 1 : -1;
            ...
            if (
              ...
              !isLeftRight &&
              !isBackspaceDelete &&
              start > indexDecimalMark &&
              start < length
            ) {
              value =
                value.substr(0, start) +
                String.fromCharCode(keyCode) +
                value.substr(start + 1, length - 1);
              inputSetValue(input, value);
          ...
          NumberOutput.prototype._setValue = function () {
            ...
            if (
              ...
              textArea.setProperty(
                "value",
                index > 0 ? out.slice(0, index + dp) : out
              );
            }
          };
        ...
        function (require, module, exports) {
          ...
          Options.prototype = {
            ...
            build: function (
              ...
              var width =
                  (listWidth < elementWidth ? elementWidth : listWidth) -
                  strokeOffset,
                posX = elementPos[0],
              ...
              var rootPosX =
                  posX + width > windowWidth
                    ? posX - width + elementWidth - strokeOffset
                    : posX,
                rootPosY =
                  posY + listHeight > windowHeight
                    ? posY - listHeight * 0.5 - elementHeight * 0.5
                    : posY;
      ...
      17: [
        function (require, module, exports) {
          ...
          function Output(parent, object, value, params) {
            ...
            params.wrap =
              params.wrap === undefined ? DEFAULT_WRAP : params.wrap;
            params.update =
              params.update === undefined ? DEFAULT_UPDATE : params.update;
            ...
            if (params.height) {
              ...
              var height = (this._height = params.height),
                padding = 4;
              textArea.setHeight(
                Math.max(height + padding, Metric.COMPONENT_MIN_HEIGHT)
              );
          ...
          Output.prototype._onDrag = function () {
            this.dispatchEvent(
              new Event_(this, ComponentEvent.INPUT_SELECT_DRAG, null)
            );
          };
      ...
      18: [
        function (require, module, exports) {
          ...
          function Pad(parent, object, value, params) {
            ...
            this._labelAxisX =
              params.labelX != "" && params.labelX != "none"
                ? params.labelX
                : null;
            this._labelAxisY =
              params.labelY != "" && params.labelY != "none"
                ? params.labelY
                : null;
            var path = this._path;
            ...
            this._svgPos = [0, 0];
            var handle = (this._handle = this._svgRoot.appendChild(
              this._createSVGObject("g")
            ));
            var handleCircle0 = handle.appendChild(
              this._createSVGObject("circle")
            );
            handleCircle0.setAttribute("r", String(11));
            handleCircle0.setAttribute("fill", "rgba(0,0,0,0.05)");
            var handleCircle1 = handle.appendChild(
              this._createSVGObject("circle")
            );
            handleCircle1.setAttribute("r", String(10));
            handleCircle1.setAttribute("fill", "rgb(83,93,98)");
            var handleCircle2 = handle.appendChild(
              this._createSVGObject("circle")
            );
            ...
            var handleCircle3 = handle.appendChild(
              this._createSVGObject("circle")
            );
          ...
          Pad.prototype._getMouseNormalized = function () {
            ...
            return [
              -1 +
                (Math.max(0, Math.min(mouse[0] - offset[0], svgSize)) /
                  svgSize) *
                  2,
              1 -
                (Math.max(0, Math.min(mouse[1] - offset[1], svgSize)) /
                  svgSize) *
                  2,
            ];
          };
      ...
      19: [
        function (require, module, exports) {
          ...
          var DocumentEvent = require("../core/document/DocumentEvent"),
            NodeEvent = require("../core/document/NodeEvent");
          var DEFAULT_VALUE_HUE = 200,
            DEFAULT_VALUE_SAT = 50,
            DEFAULT_VALUE_VAL = 50;
          function Picker(parentNode) {
            ...
            var canvasField = (this._canvasField =
                document.createElement("canvas")),
              canvasSlider = (this._canvasSlider =
                document.createElement("Canvas"));
            ...
            var contextCanvasField = (this._contextCanvasField =
                canvasField.getContext("2d")),
              contextCanvasSlider = (this._contextCanvasSlider =
                canvasSlider.getContext("2d"));
            ...
            var inputHue = (this._inputHue = new NumberInput_Internal(
                step,
                dp,
                null,
                callbackHue
              )),
              inputSat = (this._inputSat = new NumberInput_Internal(
                step,
                dp,
                null,
                callbackSat
              )),
              inputVal = (this._inputVal = new NumberInput_Internal(
                step,
                dp,
                null,
                callbackVal
              )),
              inputR = (this._inputR = new NumberInput_Internal(
                step,
                dp,
                null,
                callbackR
              )),
              inputG = (this._inputG = new NumberInput_Internal(
                step,
                dp,
                null,
                callbackG
              )),
              inputB = (this._inputB = new NumberInput_Internal(
                step,
                dp,
                null,
                callbackB
            ...
            var buttonPick = new Node(Node.INPUT_BUTTON)
                .setStyleClass(CSS.Button)
                .setProperty("value", "pick"),
              buttonCancel = new Node(Node.INPUT_BUTTON)
                .setStyleClass(CSS.Button)
                .setProperty("value", "cancel");
            var colorContrast = new Node().setStyleClass(
              CSS.PickerColorContrast
            );
            ...
            var inputFieldWrapHue = new Node().setStyleClass(
                CSS.PickerInputField
              ),
              inputFieldWrapSat = new Node().setStyleClass(
                CSS.PickerInputField
              ),
              inputFieldWrapVal = new Node().setStyleClass(
                CSS.PickerInputField
              );
            var inputFieldWrapHueLabel = new Node(Node.SPAN)
                .setStyleClass(CSS.Label)
                .setProperty("innerHTML", "H"),
              inputFieldWrapSatLabel = new Node(Node.SPAN)
                .setStyleClass(CSS.Label)
                .setProperty("innerHTML", "S"),
              inputFieldWrapValLabel = new Node(Node.SPAN)
                .setStyleClass(CSS.Label)
                .setProperty("innerHTML", "V");
            inputFieldWrapHue.addChildren(
              inputFieldWrapHueLabel,
              inputHue.getNode()
            );
            inputFieldWrapSat.addChildren(
              inputFieldWrapSatLabel,
              inputSat.getNode()
            );
            inputFieldWrapVal.addChildren(
              inputFieldWrapValLabel,
              inputVal.getNode()
            );
            var inputFieldWrapR = new Node().setStyleClass(
                CSS.PickerInputField
              ),
              inputFieldWrapG = new Node().setStyleClass(CSS.PickerInputField),
              inputFieldWrapB = new Node().setStyleClass(CSS.PickerInputField);
            var inputFieldWrapRLabel = new Node(Node.SPAN)
                .setStyleClass(CSS.Label)
                .setProperty("innerHTML", "R"),
              inputFieldWrapGLabel = new Node(Node.SPAN)
                .setStyleClass(CSS.Label)
                .setProperty("innerHTML", "G"),
              inputFieldWrapBLabel = new Node(Node.SPAN)
                .setStyleClass(CSS.Label)
                .setProperty("innerHTML", "B");
            ...
            var inputHEX = (this._inputHEX = new Node(Node.INPUT_TEXT)),
              inputFieldWrapHEX = new Node().setStyleClass(
                CSS.PickerInputField
              ),
              inputFieldWrapHEXLabel = new Node(Node.SPAN).setStyleClass(
                CSS.Label
              );
            ...
            inputHEX.addEventListener(
              NodeEvent.CHANGE,
              this._onInputHEXFinish.bind(this)
            );
            ...
            buttonPick.addEventListener(
              eventMouseDown,
              this._onPick.bind(this)
            );
            ...
            head.addEventListener(
              NodeEvent.MOUSE_DOWN,
              this._onHeadDragStart.bind(this)
            );
            ...
            this._imageDataSlider = contextCanvasSlider.createImageData(
              canvasSlider.width,
              canvasSlider.height
            );
            this._imageDataField = contextCanvasField.createImageData(
              canvasField.width,
              canvasField.height
            );
          ...
          Picker.prototype = {
            _drawHandleField: function () {
              ...
              var posX = Math.max(
                  0,
                  Math.min(mousePos[0] - nodePos[0], canvas.width)
                ),
                posY = Math.max(
                  0,
                  Math.min(mousePos[1] - nodePos[1], canvas.height)
                ),
                posXNorm = posX / canvas.width,
                posYNorm = posY / canvas.height;

              var sat = Math.round(posXNorm * this._valueSatMinMax[1]),
                val = Math.round((1 - posYNorm) * this._valueValMinMax[1]);
            ...
            _updateHandleField: function () {
              ...
              this._handleField.setPositionGlobal(
                satNorm * width - offsetHandle,
                (1 - valNorm) * height - offsetHandle
              );
            },
            _drawHandleSlider: function () {
              ...
              var posY = Math.max(
                  0,
                  Math.min(mousePosY - canvasPosY, canvas.height)
                ),
                posYNorm = posY / canvas.height;
              var hue = Math.floor((1 - posYNorm) * this._valueHueMinMax[1]);
            ...
            _updateHandleSlider: function () {
              ...
              this._handleSlider.setPositionGlobalY(
                (height - offsetHandle) * (1 - hueNorm)
              );
            },
            ...
            _onInputHueChange: function () {
              var input = this._inputHue,
                inputVal = this._getValueContrained(
                  input,
                  this._valueHueMinMax
                );
              var minMax = this._valueHueMinMax;
            ...
            _onInputSatChange: function () {
              this._setSat(
                this._getValueContrained(this._inputSat, this._valueSatMinMax)
              );
              this._onInputSVChange();
            },
            _onInputValChange: function () {
              this._setVal(
                this._getValueContrained(this._inputVal, this._valueValMinMax)
              );
              this._onInputSVChange();
            },
            _onInputRChange: function () {
              this._setR(
                this._getValueContrained(this._inputR, this._valueRGBMinMax)
              );
              this._onInputRGBChange();
            },
            _onInputGChange: function () {
              this._setG(
                this._getValueContrained(this._inputG, this._valueRGBMinMax)
              );
              this._onInputRGBChange();
            },
            _onInputBChange: function () {
              this._setB(
                this._getValueContrained(this._inputB, this._valueRGBMinMax)
              );
              this._onInputRGBChange();
            },
            ...
            _setContrastCurrColor: function (r, g, b) {
              this._colorCurrNode.setStyleProperty(
                "background",
                "rgb(" + r + "," + g + "," + b + ")"
              );
            },
            _setContrasPrevColor: function (r, g, b) {
              this._colorPrevNode.setStyleProperty(
                "background",
                "rgb(" + r + "," + g + "," + b + ")"
              );
            },
            ...
            _drawCanvasSlider: function () {
              ...
              while (++i < height) {
                j = -1;
                while (++j < width) {
                  rgb = ColorUtil.HSV2RGB((1 - i * invHeight) * 360, 100, 100);
                  index = (i * width + j) * 4;
                  imageData.data[index] = rgb[0];
                  imageData.data[index + 1] = rgb[1];
                  imageData.data[index + 2] = rgb[2];
            ...
            open: function () {
              ...
              if (position[0] === null || position[1] === null) {
                ...
                position[0] = Math.max(
                  0,
                  Math.min(position[0], window.innerWidth - node.getWidth())
                );
                position[1] = Math.max(
                  0,
                  Math.min(position[1], window.innerHeight - node.getHeight())
                );
              }
              node.setPositionGlobal(position[0], position[1]);
              this._updateCanvasNodePositions();
      ...
      20: [
        function (require, module, exports) {
          ...
          function Plotter(parent, object, value, params) {
            ...
            var grid = (this._grid = this._svgRoot.appendChild(
              this._createSVGObject("path")
            ));
            grid.style.stroke = "rgb(26,29,31)";
            var path = (this._path = this._svgRoot.appendChild(
              this._createSVGObject("path")
            ));
            path.style.stroke =
              "rgb(" +
      ...
      21: [
        function (require, module, exports) {
          ...
          function Range(parent, object, value, params) {
            ...
            var inputMin = (this._inputMin = new NumberInput_Internal(
              step,
              dp,
            ...
            var inputMax = (this._inputMax = new NumberInput_Internal(
              step,
              dp,
              this.pushHistoryState.bind(this),
      ...
      23: [
        function (require, module, exports) {
          ...
          function SVGComponent(parent, object, value, params) {
            ...
            svg.setAttribute("baseProfile", "tiny");
            wrap.getElement().appendChild(svg);
            var svgRoot = (this._svgRoot = svg.appendChild(
              this._createSVGObject("g")
            ));
          ...
          SVGComponent.prototype._pathCmdBezierCubic = function (
            cmd,
            x0,
            y0,
            cx0,
          ...
          SVGComponent.prototype._pathCmdBezierQuadratic = function (
            cmd,
            x0,
            y0,
            cx,
        ...
        function (require, module, exports) {
          ...
          function Select(parent, object, value, params) {
            ...
            select.addEventListener(
              NodeEvent.MOUSE_DOWN,
              this._onOptionTrigger.bind(this)
            );
            if (this._hasTarget()) {
              ...
              select.setProperty(
                "value",
                targetObj.toString().length > 0 ? targetObj : values[0]
              );
            } else {
              select.setProperty(
                "value",
                params.selected ? values[params.selected] : STR_CHOOSE
              );
            }
          ...
          Select.prototype._applySelected = function (selected) {
            ...
            this.dispatchEvent(
              new Event_(this, ComponentEvent.VALUE_UPDATED),
              null
            );
          };
          ...
          Select.prototype._updateAppearance = function () {
            this._select.setStyleClass(
              this._active ? CSS.SelectActive : CSS.Select
            );
          };
      ...
      25: [
        function (require, module, exports) {
          ...
          function Slider(parent, object, value, range, params) {
            ...
            var slider = (this._slider = new Slider_Internal(
              wrap,
          ...
          Slider.prototype.onPanelMoveEnd =
            ...
            Slider.prototype.onWindowResize =
              function () {
      ...
      26: [
        function (require, module, exports) {
          ...
          function Slider_Internal(parentNode, onBegin, onChange, onFinish) {
            ...
            var slot = (this._slot = {
              node: new Node().setStyleClass(CSS.SliderSlot),
              offsetX: 0,
              width: 0,
              padding: 3,
            });
            var handle = (this._handle = {
              node: new Node().setStyleClass(CSS.SliderHandle),
              width: 0,
              dragging: false,
            });
            ...
            slot.node.addEventListener(
              NodeEvent.MOUSE_DOWN,
              this._onSlotMouseDown.bind(this)
            );
            slot.node.addEventListener(
              NodeEvent.MOUSE_UP,
              this._onSlotMouseUp.bind(this)
            );
            document.addEventListener(
              DocumentEvent.MOUSE_MOVE,
          ...
          Slider_Internal.prototype._interpolateValue = function () {
            var intrpl = this._intrpl,
              bounds = this._bounds;
            this._value = bounds[0] * (1 - intrpl) + bounds[1] * intrpl;
          };
          ...
          Slider_Internal.prototype._updateFromBounds = function () {
            ...
            this._intrpl = Math.abs(
              (this._value - boundsMin) / (boundsMin - boundsMax)
            );
            this._updateHandle();
          };
          Slider_Internal.prototype.setValue = function (value) {
            ...
            this._intrpl = Math.abs(
              (value - boundsMin) / (boundsMin - boundsMax)
            );
            this._updateHandle();
            this._value = value;
          };
              ...
              var onPresetActivate = function () {
                options.build(
                  ...
                  function () {
                    input.setProperty(
                      "value",
                      presets[options.getSelectedIndex()]
                    );
                    self.pushHistoryState();
                    self.applyValue();
                  },
        ...
        function (require, module, exports) {
          ...
          function ValuePlotter(parent, object, value, params) {
            ...
            this._height = params.height =
              params.height < Metric.COMPONENT_MIN_HEIGHT
                ? Metric.COMPONENT_MIN_HEIGHT
                : params.height;
          ...
          ValuePlotter.prototype._drawGrid = function () {
            ...
            var svgWidth = Number(svg.getAttribute("width")),
              svgHeightHalf = Math.floor(
                Number(svg.getAttribute("height")) * 0.5
              );
            var pathCmd = "";
          ...
          ValuePlotter.prototype._drawCurve = function () {
            ...
            points[1] = buffer0[0];
            buffer0[bufferLength - 1] =
              value * unit * -1 + Math.floor(heightHalf);
            pathCmd += this._pathCmdMoveTo(points[0], points[1]);
            var i = 0,
              index;
      ...
      30: [
        function (require, module, exports) {
          ...
          function Component(parent, label) {
            ...
            this._parent.addEventListener(
              ComponentEvent.ENABLE,
              this,
              "onEnable"
            );
            this._parent.addEventListener(
              ComponentEvent.DISABLE,
              this,
              "onDisable"
            );
      ...
      35: [
        ...
        },
        {
          "./Component": 30,
          "./ComponentEvent": 31,
          "./ComponentObjectError": 32,
          "./History": 33,
          "./ObjectComponentNotifier": 36,
          "./event/Event": 48,
        },
      ],
      36: [
        function (require, module, exports) {
          ...
          ObjectComponentNotifier.prototype = Object.create(
            EventDispatcher.prototype
          );
          ObjectComponentNotifier.prototype.constructor =
            ObjectComponentNotifier;
          ObjectComponentNotifier.prototype.onValueUpdated = function (e) {
            this.dispatchEvent(
              new Event_(this, ComponentEvent.UPDATE_VALUE, {
                origin: e.sender,
              })
            );
          };
          ObjectComponentNotifier.prototype.onOptionTriggered = function (e) {
            this.dispatchEvent(
              new Event_(this, OptionEvent.TRIGGER, { origin: e.sender })
            );
          };
          var instance = null;
          ...
          function createWindow() {
            ...
            var window_ = window.open(
              ...
              "        width=" +
                ...
                height +
                ",        left=" +
                (window.screenX + window.innerWidth * 0.5 - width * 0.5) +
                ",        top=" +
                (window.screenY + window.innerHeight * 0.5 - height * 0.5) +
          ...
          var ColorUtil = {
            HSV2RGB: function (hue, sat, val) {
              ...
              var min_hue = 0,
                ...
                min_val = 0;
              hue = hue % max_hue;
              val = (Math.max(min_val, Math.min(val, max_val)) / max_val) * 255;
              if (sat <= min_sat) {
                val = Math.round(val);
                return [val, val, val];
        ...
        function (require, module, exports) {
          ...
          function Mouse() {
            ...
            this._onDocumentMouseWheel = function (event) {
              self._wheelDirection =
                event.detail < 0 ? 1 : event.wheelDelta > 0 ? 1 : -1;
              self.dispatchEvent(
                new Event_(self, DocumentEvent.MOUSE_WHEEL, event)
              );
            };
            document.addEventListener(
              DocumentEvent.MOUSE_MOVE,
      ...
      51: [
        function (require, module, exports) {
          ...
          function ScrollBar(parentNode, targetNode, wrapHeight) {
            ...
            var wrap = (this._wrapNode = new Node().setStyleClass(
                CSS.ScrollWrap
              )),
              node = (this._node = new Node().setStyleClass(CSS.ScrollBar)),
              track = (this._trackNode = new Node().setStyleClass(
                CSS.ScrollBarTrack
              )),
              thumb = (this._thumbNode = new Node().setStyleClass(
                CSS.ScrollBarThumb
              ));
            ...
            thumb.addEventListener(
              DocumentEvent.MOUSE_DOWN,
              this._onThumbDragStart.bind(this)
            );
            this._isValid = false;
            this._enabled = false;
            ...
            this._onMouseWheel = function (e) {
              ...
              self._scroll(
                thumb.getPositionY() +
                  sender.getWheelDirection() * scrollStep * -1
              );
          ...
          ScrollBar.prototype._onThumbDragStart = function () {
            ...
            this._mouseThumbOffset =
              mouse.getY() - this._thumbNode.getPositionGlobalY();
            var self = this;
            var onDrag = function () {
                self._scroll(
                  mouse.getY() - trackOffset - self._mouseThumbOffset
                );
              },
              onDragEnd = function () {
                document.removeEventListener(eventMove, onDrag, false);
        ...
        },
        {
          "../../component/Metric": 12,
          "../document/CSS": 42,
          "../document/DocumentEvent": 43,
          "../document/Mouse": 44,
          "../document/Node": 45,
          "../document/NodeEvent": 46,
        },
      ],
      52: [
        function (require, module, exports) {
        ...
        function (require, module, exports) {
          ...
          function Group(parent, params) {
            ...
            if (label) {
              ...
              head.addEventListener(
                NodeEvent.MOUSE_DOWN,
                this._onHeadTrigger.bind(this)
              );
              this.addEventListener(
                GroupEvent.GROUP_LIST_SIZE_CHANGE,
                parent,
                "onGroupListSizeChange"
              );
              this._updateAppearance();
            }
            ...
            parent.addEventListener(
              ...
              this,
              "onPanelScrollWrapAdded"
            );
            parent.addEventListener(
              PanelEvent.PANEL_SCROLL_WRAP_REMOVED,
              this,
              "onPanelScrollWrapRemoved"
            );
            parent.addEventListener(
              PanelEvent.PANEL_SIZE_CHANGE,
              this,
              "onPanelSizeChange"
            );
            parent.addEventListener(
          ...
          Group.prototype.onPanelMoveBegin = function () {
            this.dispatchEvent(
              new Event_(this, PanelEvent.PANEL_MOVE_BEGIN, null)
            );
          };
          ...
          Group.prototype.onPanelMoveEnd = function () {
            this.dispatchEvent(
              new Event_(this, PanelEvent.PANEL_MOVE_END, null)
            );
          };
          Group.prototype.onPanelScrollWrapAdded = function () {
            this.dispatchEvent(
              new Event_(this, GroupEvent.GROUP_SIZE_CHANGE, null)
            );
          };
          ...
          Group.prototype.onPanelHide = function () {
            this.dispatchEvent(
              new Event_(this, GroupEvent.SUBGROUP_DISABLE, null)
            );
          };
          Group.prototype.onPanelShow = function () {
            this.dispatchEvent(
              new Event_(this, GroupEvent.SUBGROUP_ENABLE, null)
            );
          };
          ...
          Group.prototype._onHeadTrigger = function () {
            ...
            this._updateAppearance();
            this.dispatchEvent(
              new Event_(this, GroupEvent.GROUP_LIST_SIZE_CHANGE, null)
            );
          };
          ...
          function isDataComp(comp) {
            return (
              comp instanceof ObjectComponent &&
      ...
      55: [
        function (require, module, exports) {
          var MenuEvent = { UPDATE_MENU: "updateMenu" };
      ...
      56: [
        function (require, module, exports) {
          ...
          function Panel(controlKit, params) {
            ...
            params.fixed =
              params.fixed === undefined ? DEFAULT_PANEL_FIXED : params.fixed;
            params.enable =
              params.enable === undefined
                ? DEFAULT_PANEL_ENABLE
                : params.enable;
            params.vconstrain =
              params.vconstrain === undefined
                ? DEFAULT_PANEL_VCONSTRAIN
                : params.vconstrain;
            if (params.dock) {
              params.dock.align = params.dock.align || DEFAULT_PANEL_DOCK.align;
              params.dock.resizable =
                params.dock.resizable || DEFAULT_PANEL_DOCK.resizable;
            }
            this._width = Math.max(
              DEFAULT_PANEL_WIDTH_MIN,
              Math.min(params.width, DEFAULT_PANEL_WIDTH_MAX)
            );
            this._height = params.height
              ? Math.max(0, Math.min(params.height, window.innerHeight))
              : null;
            ...
            var root = (this._node = new Node().setStyleClass(CSS.Panel)),
              ...
              wrap = (this._wrapNode = new Node(Node.DIV).setStyleClass(
                CSS.Wrap
              )),
              list = (this._listNode = new Node(Node.LIST).setStyleClass(
                CSS.GroupList
              ));
            root.setWidth(width);
            label_.setProperty("innerHTML", label);
            ...
            if (!dock) {
              ...
              menuHide.addEventListener(
                NodeEvent.MOUSE_DOWN,
                this._onMenuHideMouseDown.bind(this)
              );
              ...
              if (!isFixed) {
                ...
                if (position) {
                  ...
                  if (positionX != 0)
                    if (align == LayoutMode.RIGHT)
                      root.getElement().marginRight = positionX;
            ...
            if (historyIsEnabled || statesAreEnabled) {
              menu.addChildAt(new Node(), 0).setStyleClass(CSS.Wrap);
            }
            if (historyIsEnabled) {
              this._menuUndo = menu
                .getChildAt(0)
          ...
          Panel.prototype._updateAppearance = function () {
            ...
            if (!this._enabled) {
              ...
              rootNode.setHeight(
                headNode.getHeight() + this._wrapNode.getHeight()
              );
          ...
          Panel.prototype._onWindowResize = function () {
            if (this.isDocked()) {
              ...
              if (
                ...
                this.dispatchEvent(
                  new Event_(this, PanelEvent.PANEL_SIZE_CHANGE)
                );
              }
            } else {
              if (!this.isFixed()) {
          ...
          Panel.prototype._constrainHeight = function () {
            ...
            var head = this._headNode,
              wrap = this._wrapNode;
            var scrollBar = this._scrollBar;
            var panelTop = this.isDocked()
              ? 0
              : this.isFixed()
              ? 0
              : this._position[1];
            var panelHeight = hasMaxHeight
              ? this.getMaxHeight()
              : hasScrollWrap
              ? scrollBar.getTargetNode().getHeight()
              : wrap.getHeight();
            ...
            if (heightDiff < 0) {
              ...
              if (!hasScrollWrap) {
                ...
                this.dispatchEvent(
                  new Event_(this, PanelEvent.PANEL_SCROLL_WRAP_ADDED, null)
                );
                return;
              }
              ...
              if (!hasMaxHeight && hasScrollWrap) {
                ...
                this._scrollBar = null;
                this.dispatchEvent(
                  new Event_(this, PanelEvent.PANEL_SCROLL_WRAP_REMOVED, null)
                );
              }
            }
          };
          ...
          Panel.prototype._addScrollWrap = function () {
            var wrapNode = this._wrapNode,
              listNode = this._listNode,
              height =
                arguments.length == 0 ? this.getMaxHeight() : arguments[0];
          ...
          Panel.prototype.addFunctionPlotter = function (
            object,
            value,
            params
          ) {
      ...
      58: [
        function (require, module, exports) {
          ...
          function SubGroup(parent, params) {
            ...
            params.label = params.label || null;
            params.useLabels =
              params.useLabels === undefined ? true : params.useLabels;
            AbstractGroup.apply(this, arguments);
            var rootNode = this._node,
            ...
            if (label && label.length != 0 && label != "none") {
              ...
              this.addEventListener(
                GroupEvent.SUBGROUP_TRIGGER,
                this._parent,
                "onSubGroupTrigger"
              );
              headNode.addEventListener(
                DocumentEvent.MOUSE_DOWN,
                this._onHeadMouseDown.bind(this)
              );
              this._updateAppearance();
            }
            if (this.hasMaxHeight()) {
            ...
            this._parent.addEventListener(
              GroupEvent.SUBGROUP_ENABLE,
              this,
              "onEnable"
            );
            this._parent.addEventListener(
              GroupEvent.SUBGROUP_DISABLE,
              this,
              "onDisable"
            );
            this._parent.addEventListener(
          ...
          SubGroup.prototype._onTrigger = function () {
            this._updateAppearance();
            this.dispatchEvent(
              new Event_(this, GroupEvent.SUBGROUP_TRIGGER, null)
            );
          };
