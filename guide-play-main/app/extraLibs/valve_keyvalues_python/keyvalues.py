...
class KeyValues(dict):
    ...
    def parse(self, filename, encoding="ascii", mapper_type=__OrderedDict, key_modifier=None):
        """
        ...
        encodings = [self.encoding, 'ascii', 'utf-8', 'ISO-8859-1']
        ...
        while encodings:
            try:
                ...
                print("encoding {} failed - trying next".format(encoding))
                encodings.pop(0)
        ...
        #                                     key_modifier=key_modifier or self.key_modifier)
        # except:
        #     print("ascii failed - trying utf-8")
